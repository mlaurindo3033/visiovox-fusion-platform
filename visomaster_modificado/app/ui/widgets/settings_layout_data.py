...
SETTINGS_LAYOUT_DATA: LayoutDictTypes = {
    'General': {
        ...
        'BenchmarkThreadsButton': {
            'level': 1,
            'label': 'Benchmark Threads',
            'help': 'Executa um teste automático de desempenho para diferentes números de threads e mostra o resultado ideal para seu hardware.',
            'exec_function': control_actions.run_benchmark_threads,
            'exec_function_args': [],
        },
        'FaceSegmentationMethodSelection': {
            'level': 1,
            'label': 'Método de Segmentação de Rosto',
            'type': 'ComboBox',
            'options': ['Nenhum', 'Face Parsing Tradicional', 'SAM 2'],
            'default': 'Face Parsing Tradicional',
            'help': 'Escolha o método de segmentação de rosto para blend e recorte: Nenhum (swap puro), tradicional (Mediapipe) ou SAM 2 (Meta).',
        },
        'SAM2ModelSelectionSelection': {
            'level': 1,
            'label': 'Modelo SAM 2',
            'type': 'ComboBox',
            'options': ['Rápido (Tiny)', 'Equilibrado (Small)', 'Qualidade Máxima (Large)'],
            'default': 'Rápido (Tiny)',
            'help': 'Escolha o modelo SAM 2 conforme sua máquina: Tiny (rápido), Small (equilibrado), Large (máxima qualidade).',
            'parentSelection': 'FaceSegmentationMethodSelection',
            'requiredSelectionValue': 'SAM 2',
        },
    },
    'Video Settings': {
