...
def show_model_loading_dialog(main_window: 'MainWindow'):
    # Esta função é chamada pela conexão ao sinal model_loading_signal
    # Para compatibilidade com código existente, mantemos esta função
    # mas não fazemos nada aqui, pois o loading_progress_dialog já é gerenciado
    # diretamente pelos sinais do models_processor
    pass

@QtCore.Slot()
def hide_model_loading_dialog(main_window: 'MainWindow'):
    # Esta função é chamada pela conexão ao sinal model_loaded_signal
    # Para compatibilidade com código existente, mantemos esta função
    # mas não fazemos nada aqui, pois o loading_progress_dialog já é gerenciado
    # diretamente pelos sinais do models_processor
    pass
